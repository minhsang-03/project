...
>
> Looking at this bar chart showing average cost per goal across the five leagues, the disparities are obvious. The Spanish La Liga achieves goals at just fivehundred-and-thirty-thousand Euros, which is remarkably efficient. The German Bundesliga comes in slightly higher at sixhundred-and-eighty-thousand Euros. France's Ligue 1 costs eighthundred-and-seventy-thousand Euros per goal. Italy's Serie A requires one-point-one million euros per goal. But the English Premier League stands as a dramatic outlier at **two point seven million euros per goal**.
>
> To put this in perspective, **the Premier League pays more than five times as much on transfers as La Liga for each goal scored**. This is an enormous differential that cannot be explained by proportionally better results or higher quality football.
>
> Despite this massive spending advantage, the competitive outcomes across all five leagues are essentially identical. This shouldn't surprise us—all five leagues operate with the same structural conditions: the same number of teams, the same games per season, and the same scoring system. Given these identical conditions, equivalent point distributions are exactly what we'd expect. What's truly striking isn't that points are similar, but rather that the Premier League pays five times as much to achieve the same results as La Liga.
>
> How do we explain this cost disparity when sporting outcomes are identical? The answer lies in what economists call a **'branding premium'**. The Premier League benefits from massive global television revenues, particularly from broadcasting deals in Asia, North America, and the Middle East. These revenues drive up player valuations and transfer fees beyond what pure sporting merit would justify. Clubs pay inflated prices not because players are five times more talented, but because the Premier League brand commands premium pricing in the global market.
>
...
>
> **Metropolitan and economically wealthy regions dominate elite European football, though the degree varies significantly by league.** The Premier League shows strong clustering in London and the northwest corridor connecting Manchester and Liverpool, though geographic advantage is not absolute. In La Liga, success gravitates toward Madrid and Barcelona, but regional competitors like Valencia, Sevilla, and Bilbao occasionally break through. Serie A concentrates heavily in the wealthy northern industrial corridor—Milan, Turin, and Bergamo—with central and southern clubs like Roma and Napoli rarely penetrating the elite. Ligue 1 is heavily centralized around Paris, though determined provincial challengers like Lens, Marseille, Monaco, Nice, Lille, and Brest periodically achieve top-five finishes. The Bundesliga stands out as the most geographically distributed elite, with consistent representation from Bavaria (Munich), the Ruhr Valley (Dortmund), eastern Germany (Leipzig), and smaller cities like Stuttgart, Frankfurt, and Freiburg all competing regularly for top positions.
>
...
>
> However, some provincial clubs demonstrate that efficiency can partially overcome geographic disadvantage. Teams like Stade Brestoise in western France, or SC Freiburg in Germany show that smart recruitment and excellent coaching can compete with bigger-city rivals.
>
...
>
> For challenger clubs trying to break into the elite, the sobering implication is that **overcoming structural wealth gaps requires exceptional efficiency**. 
...
> "As an additional analytical technique, we implemented **K-means clustering**.
>
